(function($) {
    ...
    $.ScrollView.prototype = $.extend({
        ...
        finishLoading: function(argument) {
            this.topActivated = false;
            $(this.el.top).removeClass('top-activated');
            $(this.el.top).addClass('top-animating');
            this.el.topLoading.style.webkitTransform = 'translate3d(0,'+(-this.barHeight)+',0)';
        ...
        handleEvent: function(e) {
                ...
                if (!this.topActivated) {
                    ...
                    if (this.draging.isDraging) {
                        ...
                        if (rubberOffset > this.barHeight) {
                            ...
                            this.el.topLoading.style.webkitTransform = 'translate3d(0,'+(rubberOffset - this.barHeight)+'px,0)'
                        } else {
                            this.readyToActivate = false;
            ...
            case 'touchend':
                ...
                if (this.draging.isDraging) {
                    ...
                    this.draging.isDraging = false;
                    $(this.el.top).addClass('top-animating');
                    this.el.topLoading.style.webkitTransform = 'translate3d(0,0,0)';
                    this.el.scroller.style.webkitTransform = 'translate3d(0,0,0)';
                }
                this.draging.pre = 0;
                this.readyToActivate = false;
        ...
        handleEvent: function(e) {
            ...
            case 'touchmove':
                ...
                if (!this.topActivated && !!this.el.warper.scrollTop) {
                    if (-this.el.warper.scrollTop > this.barHeight) {
                        this.readyToActivate = true;
                        this.draging.offset = -this.el.warper.scrollTop;
                        this.el.topLoading.style.webkitTransform = 'translate3d(0,'+(this.draging.offset - this.barHeight)+'px,0)'
                        $(this.el.top).addClass('top-activating');
                    } else {
                        this.readyToActivate = false;
                        this.draging.offset = 0;
                        $(this.el.top).removeClass('top-activating');
                    }
                }
                break;
            case 'touchend':
                $(this.el.top).removeClass('top-activating');
                if (this.readyToActivate) {
                    console.log((this.draging.offset - this.barHeight));
                    $(this.el.top).addClass('top-animating');
                    this.el.topLoading.style.webkitTransform = 'translate3d(0,0,0)';
                    this.startLoading();
                }
